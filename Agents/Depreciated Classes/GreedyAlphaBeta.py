...
'''
DEPRECIATED CLASS 
THIS WAS THE FIRST ATTEMPED AT GREEDY MOVE ORDERING TO IMPROVE ALPHA BETA PRUNING 
WHAT WAS FOUND THAT DUE TO THE SORTING ALGORITHM AND CONSTRUCTION AND EVALUATION OF THE ACTIONS, 
THIS ACTUALLY SLOWED DOWN AB TOO MUCH SUCH THAT IT WAS SLOWER WITH THE MOVE ORDERING THAN WITHOUT 

WE OPTED FOR A NEGAMAX IMPLEMENTATION OF MINIMAX-AB TO SIMPLIFY THE CODE AND ALSO SIMPLIFY 
THE GREEDY NATURE OF MOVE ORDERING / PICKING A SUBSET OF MOVES
'''
